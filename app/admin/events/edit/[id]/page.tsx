    ...
    <div className="min-h-screen bg-gradient-to-br from-stone-100 via-amber-50 to-stone-200 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              ...
              <div>
                ...
                <p className="text-emerald-200 text-sm">イベント編集</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl font-bold text-emerald-800 mb-2">イベント編集</h1>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl border-4 border-emerald-700">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Description */}
            <div>
              <label htmlFor="description" className="block text-lg font-semibold text-emerald-700 mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Date */}
              <div>
                <label htmlFor="date" className="block text-lg font-semibold text-emerald-700 mb-2 flex items-center">
